...
- **Web Development** — HTML, CSS, JavaScript, responsive design, secure coding practices
- **Cybersecurity** — Network security, security operations, threat detection, log analysis, vulnerability awareness
- **Automation & AI** — Python, PowerShell, scripting, and practical AI tools for productivity and problem-solving

### Featured Projects
| Project | Description |
|---------|-------------|
| [Network-Vulnerability-Scanner](https://github.com/bedashto/Network-Vulnerability-Scanner) | Python tool for scanning open ports and detecting vulnerabilities |
| [Automated-Log-Analyzer](https://github.com/bedashto/Automated-Log-Analyzer) | Python script that analyzes server logs for failed logins, high-request IPs, and brute-force patterns |
| [Phishing-Detector-With-ML](https://github.com/bedashto/Phishing-Detector-With-ML) | Machine learning-based tool for detecting phishing attempts in URLs and emails |
| [shopsmart-ecommerce-demo](https://github.com/bedashto/shopsmart-ecommerce-demo) | E-commerce demo built with JavaScript |
